 ...
 * @Malon
 */
public class VTCDElementErrorDialog extends AbstractDetailsDialog{
	
	private final Object details;
	   
	   public VTCDElementErrorDialog(Shell parentShell, String title, Image image, String message, Object details, Image imageTitle) {
	   ...
	   public static String getMessage(
			      ...
			      if (details instanceof Throwable) {
			         ...
			         return MessageFormat.format(
			            message,
			            new Object[] { VTCDEditPlugin.INSTANCE.getString("_UI_VTCDElementErrorDialog_DefaultUserError")});
			      }
			      if (details instanceof IStatus) {
