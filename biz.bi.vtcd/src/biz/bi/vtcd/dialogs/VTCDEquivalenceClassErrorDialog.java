 ...
 * @Malon
 */
public class VTCDEquivalenceClassErrorDialog extends AbstractDetailsDialog{
	 ...
	 * @param p_imageTitle
	 */
	public VTCDEquivalenceClassErrorDialog(Shell parentShell, String title, Image image, String message, Object details, Image imageTitle) {
	...
	/* (non-Javadoc)
	 * @see biz.bi.vtcd.dialogs.AbstractDetailsDialog#createDetailsArea(org.eclipse.swt.widgets.Composite)
	 */
	protected Control createDetailsArea(Composite p_parent) {
//		 create the details area
	      Composite panel = new Composite(p_parent, SWT.NONE);
	...
	public static String getMessage(
		      ...
		      if (details instanceof Throwable) {
		         ...
		         return MessageFormat.format(
		            message,
		            new Object[] { VTCDEditPlugin.INSTANCE.getString("_UI_VTCDEquivalenceClassErrorDialog_DefaultUserError")});
		      }
		      if (details instanceof IStatus) {
