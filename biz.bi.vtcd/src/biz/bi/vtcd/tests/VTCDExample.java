 ...
 * </copyright>
 *
 * $Id: VTCDExample.java,v 1.2 2005/06/29 20:45:06 smoreno Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>vtcd</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class VTCDExample {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(VTCDPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.vtcd"));
				VTCDDiagramCombination root = VTCDFactory.eINSTANCE
