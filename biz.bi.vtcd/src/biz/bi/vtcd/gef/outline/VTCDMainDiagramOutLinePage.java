...
public class VTCDMainDiagramOutLinePage extends ContentOutlinePage implements IAdaptable {
	static final int ID_OUTLINE  = 0;
	  static final int ID_OVERVIEW = 1;
	  
	  private AdapterFactory adapterFactory;
	  private VTCDMainDiagramEditor editor;
	...
	public VTCDMainDiagramOutLinePage(VTCDMainDiagramEditor editor, AdapterFactory p_adapterFactory) {
	...
	private void initializeOutlineViewer() {
	    viewer.setContents(editor.getM_VTCDDiagramMain().getM_TestObject());
	  }
}
