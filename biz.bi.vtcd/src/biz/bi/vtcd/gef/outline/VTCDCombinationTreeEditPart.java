 ...
 * @hcanedo
 */
public class VTCDCombinationTreeEditPart extends VTCDBaseTreeEditPart {

	/**
	 * @param p_model
	 */
	public VTCDCombinationTreeEditPart(Object p_model) {
		super(p_model);
	...
	protected Image getImage() {
		return VTCDImages.getImage(VTCDImages.COMBINATION);
	}
	...
	protected String getText() {
		return getCMProxyCombination().toString();
	}

	public CMProxyCombination getCMProxyCombination(){
