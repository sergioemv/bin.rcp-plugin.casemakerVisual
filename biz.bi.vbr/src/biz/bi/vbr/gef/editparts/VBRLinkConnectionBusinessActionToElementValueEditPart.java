 ...
 * @since 09-09-2005
 */
public class VBRLinkConnectionBusinessActionToElementValueEditPart extends VBRBaseLinkEditPart{

	/* (non-Javadoc)
	 * @see biz.bi.vbr.gef.editparts.VBRBaseLinkEditPart#handlePropertyChanged(org.eclipse.emf.common.notify.Notification)
	 */
	VBRLinkConnectionBusinessActionToElementValueEditPart(Object p_model){
