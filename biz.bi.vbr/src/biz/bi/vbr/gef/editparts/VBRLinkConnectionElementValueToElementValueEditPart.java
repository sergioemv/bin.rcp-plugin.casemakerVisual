 ...
 * @since 09-09-2005
 */
public class VBRLinkConnectionElementValueToElementValueEditPart extends VBRBaseLinkEditPart {

	/* (non-Javadoc)
	 * @see biz.bi.vbr.gef.editparts.VBRBaseLinkEditPart#handlePropertyChanged(org.eclipse.emf.common.notify.Notification)
	 */
	VBRLinkConnectionElementValueToElementValueEditPart(Object model){
		this.setModel(model);
	}
