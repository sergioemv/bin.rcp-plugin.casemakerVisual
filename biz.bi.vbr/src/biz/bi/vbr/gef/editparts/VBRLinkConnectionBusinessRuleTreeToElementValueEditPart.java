 ...
 * @since 09-09-2005
 */
public class VBRLinkConnectionBusinessRuleTreeToElementValueEditPart extends VBRBaseLinkEditPart{

	/* (non-Javadoc)
	 * @see biz.bi.vbr.gef.editparts.VBRBaseLinkEditPart#handlePropertyChanged(org.eclipse.emf.common.notify.Notification)
	 */
	VBRLinkConnectionBusinessRuleTreeToElementValueEditPart(Object p_model){
