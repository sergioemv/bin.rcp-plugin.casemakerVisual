 ...
 * </copyright>
 *
 * $Id: InferenceRuleItemProvider.java,v 1.5 2005/09/20 19:03:42 hcanedo Exp $
 */
...
/**
 * This is the item provider adapter for a {@link biz.bi.vbr.InferenceRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InferenceRuleItemProvider extends ItemProviderAdapter implements
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/InferenceRule"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return getString("_UI_InferenceRule_type"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(VBRPackage.eINSTANCE
				.getInferenceRule_TruePart(), VBRFactory.eINSTANCE
				.createBusinessValue()));
		...
		newChildDescriptors.add(createChildParameter(VBRPackage.eINSTANCE
				.getInferenceRule_FalsePart(), VBRFactory.eINSTANCE
				.createBusinessValue()));
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == VBRPackage.eINSTANCE
				.getInferenceRule_TruePart()
				|| childFeature == VBRPackage.eINSTANCE
						.getInferenceRule_FalsePart();
