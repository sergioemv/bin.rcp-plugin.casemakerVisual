 ...
 * </copyright>
 *
 * $Id: VBRActionBarContributor.java,v 1.1 2005/07/29 20:10:45 cmendezroca Exp $
 */
...
/**
 * This is the action bar contributor for the VBR model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VBRActionBarContributor extends EditingDomainActionBarContributor
	 ...
	 * @generated
	 */
	public VBRActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("vbr-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("vbr-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				VBRModelEditPlugin.INSTANCE.getString("_UI_VBREditor_menu"), "biz.bi.vbrMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(VBRModelEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(VBRModelEditPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(VBRModelEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
