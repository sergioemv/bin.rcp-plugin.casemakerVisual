 ...
 * </copyright>
 *
 * $Id: VBRVMActionBarContributor.java,v 1.1 2005/07/29 20:10:45 cmendezroca Exp $
 */
...
/**
 * This is the action bar contributor for the VBRVM model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VBRVMActionBarContributor extends
	 ...
	 * @generated
	 */
	public VBRVMActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("vbrvm-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("vbrvm-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				VBRModelEditPlugin.INSTANCE.getString("_UI_VBRVMEditor_menu"), "biz.bi.vbr.vbrvmMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
