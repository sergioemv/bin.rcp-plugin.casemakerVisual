...
public class VBRImages {
	...
	public static final String PALETTE_LINK_VBRACTION_ELEMENTVALUE = "connect action to value";
	public static final String PALETTE_LINK_ELEMENTVALUE_VBRACTION = "connect value to action";
	public static final String PALETTE_LINK_ELEMENTVALUE_ELEMENTVALUE = "connect value to value";
	public static final String PALETTE_BUSINESSTREE = "business tree";
	public static final String PALETTE_BUSINESSACTION = "business action";
